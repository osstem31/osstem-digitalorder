...
export default function Header() {
  ...
  const digitalOrderCategories = [
    ...
    { name: '상담예약', count: '0', path: '/preparing' },
  ];
  ...
  return (
    <header className="w-full bg-white font-pretendard">
      ...
      <div className="bg-white border-b border-[#E6E6E6] sticky top-0 z-[110]">
        <div className="max-w-[1800px] w-full mx-auto flex items-center h-[44px] relative">
          <div className="flex items-center h-full gap-10 absolute left-[54.5%] -translate-x-1/2">
